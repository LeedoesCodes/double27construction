...
>
    <div class="container-x flex h-16 items-center justify-between gap-4 sm:h-20">
        {{-- Brand: logo mark on a soft rounded chip + wordmark --}}
        <a href="{{ route('home') }}" class="flex items-center gap-3">
            <img
                src="{{ asset('storage/site/logo-mark.png') }}"
                alt="{{ $site->company_name }}"
                class="h-11 w-11 rounded-xl bg-white object-contain p-1 sm:h-12 sm:w-12"
            >
            <span class="font-display leading-none">
                <span class="block text-lg font-semibold uppercase tracking-wide text-white sm:text-xl">Double 27</span>
                <span class="mt-1 block text-[10px] font-medium uppercase tracking-[0.25em] text-neutral-400">Construction Supply</span>
            </span>
        </a>
        ...
        <button
            ...
            class="inline-flex h-11 w-11 items-center justify-center rounded-lg border border-ink-700 text-neutral-200 lg:hidden"
        >
